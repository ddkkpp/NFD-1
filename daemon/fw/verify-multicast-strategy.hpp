...
#ifndef NFD_DAEMON_FW_VERIFY_MULTICAST_STRATEGY_HPP
#define NFD_DAEMON_FW_VERIFY_MULTICAST_STRATEGY_HPP
 ...
 */
class VerifyMulticastStrategy : public Strategy
{
public:
  explicit
  VerifyMulticastStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
